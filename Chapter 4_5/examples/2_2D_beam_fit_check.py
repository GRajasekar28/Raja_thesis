# -*- coding: utf-8 -*-
"""
Created on Fri Jul 28 08:45:05 2023
...
## WITHOUT DAMAGE
### VALIDATION OF GKV FIT obtained using  'lib/fit_mod_3_point_bending.py' ##########
## validation of GKV fit parameters is done because fit was performed on a unnotched specimen supported at the ends
## but the SENB test has a notch not supported at the ends
#######################################################################
...
ni = 3
E = [2.02082346e+08, 2.07043372e+07, 5.26510807e+06]
tau = [  6.64181083, 105.68469256]
nu = 0.2
...
max_displacement_y = [i/1000 for i in [2,2,2]]    ## m    
#stop_forces = [5,2, .1]                                  #  N
tot_time = []
